  ...
  a_.OpSwitch(dxbc::Src::R(temp, dxbc::Src::kXXXX));
  {
    ...
    auto pack_8_16_32 = [&](std::array<uint32_t, 4> widths) {
      ...
      a_.OpIf(true, num_format_signed);
      {
        ...
        while (rex::bit_scan_forward(eM_remaining, &eM_index)) {
          eM_remaining &= ~(uint8_t(1) << eM_index);
          uint32_t eM = system_temps_memexport_data_[eM_index];
          a_.OpBFI(dxbc::Dest::R(round_bias_temp, components), dxbc::Src::LU(31),
    ...
    auto f32_to_f16_extended_range = [&](uint32_t components) {
      ...
      while (rex::bit_scan_forward(eM_remaining_ext, &eM_index_ext)) {
        ...
        a_.OpMov(dxbc::Dest::R(ext_original_temp, components), dxbc::Src::R(eM));
        ...
        a_.OpAnd(dxbc::Dest::R(ext_mask_temp, components), dxbc::Src::R(eM),
                 dxbc::Src::LU(0x7C00));
        a_.OpIEq(dxbc::Dest::R(ext_mask_temp, components), dxbc::Src::R(ext_mask_temp),
                 dxbc::Src::LU(0x7C00));
        ...
        a_.OpMin(dxbc::Dest::R(ext_original_temp, components), dxbc::Src::R(ext_original_temp),
                 dxbc::Src::LF(131008.0f));
        a_.OpMax(dxbc::Dest::R(ext_original_temp, components), dxbc::Src::R(ext_original_temp),
                 dxbc::Src::LF(-131008.0f));
        // 2. Halve to bring into standard float16 range (max 65504).
        a_.OpMul(dxbc::Dest::R(ext_original_temp, components), dxbc::Src::R(ext_original_temp),
                 dxbc::Src::LF(0.5f));
        ...
        a_.OpIAdd(dxbc::Dest::R(ext_original_temp, components), dxbc::Src::R(ext_original_temp),
                  dxbc::Src::LU(0x0400));
