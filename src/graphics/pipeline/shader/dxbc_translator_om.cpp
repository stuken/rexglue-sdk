...
void DxbcShaderTranslator::ROV_AddPassedMSAASamplesToZPD() {
  ...
  dxbc::Src counter_index_src(LoadSystemConstant(
      SystemConstants::Index::kZpdRovCounterIndex, offsetof(SystemConstants, zpd_rov_counter_index),
      dxbc::Src::kXXXX));
...

  {
    ...
    a_.OpIf(true, temp_x_src);
    {
      ...
      a_.OpUMul(dxbc::Dest::Null(), temp_y_dest, counter_index_src, dxbc::Src::LU(sizeof(uint32_t)));
